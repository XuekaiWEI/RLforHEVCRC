...
class ActorNetwork(object):
    ...
    def __init__(self, sess, state_dim, action_dim, learning_rate):
        ...
        # Compute the objective (log action_vector and entropy) mul to multiply
    ...
    def create_actor_network(self):
        with tf.variable_scope('actor'):
            ...
            reshape_0 = tflearn.reshape(inputs[:, 0:5, :], [-1, 5, self.s_dim[1], 1])
            conv2d01 = tflearn.conv_2d(reshape_0, 256, 3, activation='relu')
            split_1 = tflearn.conv_1d(inputs[:, 5:6, :], 128, 4, activation='relu')

            flatten_1 = tflearn.flatten(split_1)

            conv2d02 = tflearn.conv_2d(conv2d01, 512, 3, activation='relu')

            conv2d02_flat = tflearn.flatten(conv2d02)

            merge_net = tflearn.merge([conv2d02_flat, flatten_1], 'concat')
...
class CriticNetwork(object):
    ...
    def __init__(self, sess, state_dim, learning_rate):
        ...
        # Temporal Difference, will also be weights for actor_gradients/sub 2 subtract
